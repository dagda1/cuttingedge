import { TextLink, Tiles, Stack, Text, Box, Inline } from '@cutting/component-library';
  ...
  return (
    <ApplicationLayout heading="Open Source Contributions">
      <Stack space="large">
        ...
        <Stack space="small">
          <TextLink external href="https://github.com/backstage/backstage/pulls?q=is%3Apr+is%3Amerged+author%3Adagda1">
          ...
          <TextLink external href="https://github.com/jaredpalmer/after.js/pulls?q=is%3Apr+author%3Adagda1+is%3Aclosed">
