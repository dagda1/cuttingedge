...
import { OSS } from '../../pages/Panels/OSS/OSS';
import { Highlights } from '../../pages/Panels/Highlights/Highlights';
import { MobileContainer } from '../../pages/Home/MobileContainer';
import { Frameworks } from '../../pages/Panels/Frameworks/Frameworks';
import { Services } from '../../pages/Panels/Services/Services';
import { Clients } from '../../pages/Panels/Clients/Clients';
