    ...
    >
      <PageBlock>
        <Stack space="medium">
          ...
          <Text component="p">
            Is your frontend software project spiraling into the abyss? Complexities, delays, and unexpected issues
            throwing you off course? We can be your beacon in the storm of frontend software development.
          </Text>
          <Text component="p">
          ...
          <Text component="p">
            We don't stop at fixing the problem. We turn challenges into opportunities. Once we've set your project back
            on track, we equip your team with the knowledge and tools needed to maintain momentum and avoid similar
            hiccups in the future.
          </Text>
          <Heading level="2">Your Success, Our Mission</Heading>
          <Text component="p">
            we believe in every software project's potential for success. With our frontend rescue services, you're not
            just saving your project, but you're setting it up for long-term victory.
          </Text>
          <Text component="p">
