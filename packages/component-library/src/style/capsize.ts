...
export function computeValues(options: CapsizeOptions): CapsizeValues {
...
function capsize(options: CapsizeOptions): CapsizeStyles {
  return createCss(_computeValues(options));
}

export function createCss({ lineHeight, fontSize, capHeightTrim, baselineTrim }: CapsizeValues): CapsizeStyles {
  return {
    fontSize,
    lineHeight,
    '::before': {
