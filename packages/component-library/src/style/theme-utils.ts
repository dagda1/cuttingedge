...
const makeMediaQuery = (breakpoint: keyof typeof breakpoints) => (styles: Properties<string | number>) =>
...
type CSSProps = Properties<string | number> & { [P in SimplePseudos]?: Properties<string | number> };
...
export const mapToProperty =
  ...
  (value: string | number): StyleRule | typeof styleRule => {
