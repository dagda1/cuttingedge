...
__export(exports, {
  ...
  cuttingTheme: () => cuttingTheme,
  defaultTheme: () => defaultTheme,
  makeTheme: () => makeTheme,
  markResetImported: () => markResetImported,
  palette: () => palette,
...
var import_util = __toModule(require("@cutting/util"));
...
var responsiveStyle = ({ mobile, tablet, desktop }) => {
  const mobileStyles = typeof mobile === "undefined" ? {} : (0, import_util.omit)(mobile, "@media");
  const tabletStyles = !tablet || (0, import_util.isEqual)(tablet, mobileStyles) ? null : tablet;
  const stylesBelowDesktop = tabletStyles || mobileStyles;
  const desktopStyles = !desktop || (0, import_util.isEqual)(desktop, stylesBelowDesktop) ? null : desktop;
...
var import_dedent = __toModule(require("dedent"));
...
var import_util2 = __toModule(require("@cutting/util"));

// src/style/themes/tokens.ts
var import_polished = __toModule(require("polished"));
var colors = {
...
var tokens = {
  space: __spreadValues({
    ...
    acc[`${i + 1}x`] = (0, import_polished.rem)(curr);
    return acc;
  }, {})),
  ...
  radios: {
    ...
    regular: {
      width: (0, import_polished.rem)(44),
      height: (0, import_polished.rem)(44)
    }
  }
};
...
var makeTheme = (customTokens = {}) => {
  ...
  const resolvedTokens = {
    ...
    fontWeight: (0, import_util2.mapValues)(tokens2.typography.fontWeight, String),
    inlineFieldSize: {
      standard: "2.5rem",
      small: "1.25rem"
    },
