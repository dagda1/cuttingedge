...
var ErrorMessage = ({
  ...
  id,
  "data-selector": dataSelector,
  className: cs4(root3, className)
}, /* @__PURE__ */ React.createElement("span", {
  className: visuallyHidden
}, "Error:"), errorMessage);

// src/components/atoms/Button/Button.tsx
import cs5 from "classnames";
...
var Button = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement("button", __spreadValues({
    className: cs5(className, root4, buttons[buttonStyle], { [disabled]: disabled2 }),
    type,
    onClick,
    disabled: disabled2,
    title,
...
var LoadingIcon = ({ darkMode }) => /* @__PURE__ */ React.createElement("svg", {
  ...
  className: cs6(bar, { [dark]: darkMode })
}))), /* @__PURE__ */ React.createElement("g", {
  className: dots
...
import cs8 from "classnames";
import { useRef } from "react";

// src/utl/prefixer/index.ts
import { uniqueId } from "@cutting/util";
var prefixId = (prefix = "ctrl") => `${prefix}${uniqueId()}`;
...
function FormControl(Comp) {
  const FormControlWrapper = (_a) => {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      className: cs8(root5, { [horizontal]: layout === "horizontal", [error]: invalid3, [highlight]: highlight2 }, className)
    }, /* @__PURE__ */ React.createElement(Label, {
...
function RadioGroup({
  ...
  const optionsWithIds = useRef2(radioOptions.map((o, index) => __spreadProps(__spreadValues({}, o), {
    name,
    id: o.id || `${name}-${index}`
  })));
  ...
  return /* @__PURE__ */ React.createElement("fieldset", {
    ...
    className: cs10(legend, { [srOnlyLegend]: legendMode === "screen-reader-only" })
  }, legend2), /* @__PURE__ */ React.createElement("div", {
    className: cs10(className, {
...
var ApplicationLayoutWithRouterScroll = (props) => {
  const root6 = useRef3(null);
  useScrollToTop({ ref: root6 });
