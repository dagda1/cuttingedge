...
var setupTestsCandidates = [
  path_1.default.resolve(".", setupTestsFileName),
  path_1.default.resolve("src", "tests", setupTestsFileName),
];
var localSetupTestsFile = setupTestsCandidates.find(
...
var jestConfig = {
  ...
  transform: {
    ...
    "^(?!.*\\.(js|jsx|css|json)$)": path_1.default.join(
      __dirname,
      "./fileTransform.js"
    ),
