    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                rootDir = finders_1.find(cwd, function (dir) {
                    var pkgJsonPath = path_1.default.join(dir, 'package.json');
                    return fs_1.default.existsSync(pkgJsonPath) === true && require(pkgJsonPath).workspaces !== undefined;
                });
