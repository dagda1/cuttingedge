...
var getPublicUrlOrPath_1 = __importDefault(
...
var publicUrlOrPath = (0, getPublicUrlOrPath_1.default)(
  process.env.NODE_ENV === "development",
  undefined,
  process.env.PUBLIC_URL
);
var resolveOwn = function (relativePath) {
...
var nodePaths = (process.env.NODE_PATH || "")
  ...
  .filter(function (folder) {
    return !path_1.default.isAbsolute(folder);
  })
  .map(resolveApp);
var appNodeModules = (0, finders_1.findAppNodeModules)(process.cwd());
var resolvedNodeModules = [appNodeModules, "./node_modules"]
  .filter(function (m) {
    return fs_1.default.existsSync(m);
  })
  .map(function (m) {
    return path_1.default.relative(process.cwd(), m);
  });
var libPackages = [
  "packages/devtools",
  "packages/testing",
  ...
  return path_1.default.resolve(process.cwd(), dep);
});
...
var tsConfigProduction = fs_1.default.existsSync(tsConfigProductionPath)
  ? tsConfigProductionPath
  : tsConfigPath;
var outDir =
  ((_a = tsConfig.compilerOptions) === null || _a === void 0
    ? void 0
    : _a.outDir) || DefaultBuildDir;
var isCommonJs =
  ((_c =
    (_b = tsConfig.compilerOptions) === null || _b === void 0
      ? void 0
      : _b.module) === null || _c === void 0
    ? void 0
    : _c.toLowerCase()) === "commonjs";
