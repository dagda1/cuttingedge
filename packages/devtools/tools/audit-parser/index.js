    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const [report, ...vulnerabilities] = auditResult
                ...
                .map((s) => JSON.parse(s));
            const totalDependencies = (_a = report === null || report === void 0 ? void 0 : report.data) === null || _a === void 0 ? void 0 : _a.totalDependencies;
            ...
            const { name, version } = yield Promise.resolve().then(() => __importStar(require(path_1.default.join(process.cwd(), 'package.json'))));
            ...
            for (let i = 0; i < failures.length; i++) {
                ...
                const { data: { advisory, recommendation, resolution: { path }, }, } = failure;
...
program
    ...
    .action((_, options = []) => __awaiter(void 0, void 0, void 0, function* () {
    yield audit(options);
}));
