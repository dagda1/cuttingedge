...
var InterpolateHtmlPlugin_1 = __importDefault(
  require("react-dev-utils/InterpolateHtmlPlugin")
);
var react_refresh_webpack_plugin_1 = __importDefault(
...
var html_webpack_partials_plugin_1 = __importDefault(
  require("html-webpack-partials-plugin")
);
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
var ModuleNotFoundPlugin_1 = __importDefault(
...
var configure = function (options, overrides) {
  ...
  var _b = (0, getUrlParts_1.getUrlParts)({
      ssrBuild: ssrBuild,
  ...
  options.publicUrl =
    publicPath.length > 1 && publicPath.substr(-1) === "/"
  ...
  var finalEntries = Object.keys(iter).reduce(function (acc, key) {
    ...
    acc[key] = __spreadArray(
      __spreadArray([], __read(polyfills), false),
      __read(entryPoints),
      false
    );
    return acc;
  }, {});
  var template = publicDir
    ? path_1.default.join(publicDir, "index.html")
    : "public/index.html";
  ...
  var config = (0, webpack_merge_1.merge)(common, overrides, {
    ...
    devServer: isDevelopment
      ? (0, createDevServer_1.createDevServer)({
          protocol: protocol,
          sockPort: sockPort,
          proxy: proxy,
          port: port,
        ...
        ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
          function (info) {
            return path_1.default
              .relative(paths_1.paths.appSrc, info.absoluteResourcePath)
              .replace(/\\/g, "/");
          }
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          function (info) {
  ...
  createWebpackOptimisation_1.createWebpackOptimisation)({
