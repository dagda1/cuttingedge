...
var webpack_node_externals_1 = __importDefault(
  require("webpack-node-externals")
);
var paths_1 = require("../config/paths");
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
var razzle_start_server_webpack_plugin_1 = __importDefault(
  require("razzle-start-server-webpack-plugin")
);
...
var configure = function (options, overrides) {
  ...
  var common = (0, common_1.configureCommon)(
  ...
  var publicPath = (0, getUrlParts_1.getUrlParts)({
    ssrBuild: true,
    isProduction: isProduction,
  }).publicPath;
  var entries = Array.isArray(options.entries)
    ? options.entries
    : [options.entries];
  var nodeArgs;
  if (isDevelopment) {
  ...
  var config = (0, webpack_merge_1.merge)(common, overrides, {
    ...
    entry: isDevelopment
      ? __spreadArray(["webpack/hot/poll?300"], __read(entries), false)
      : entries,
    output: {
