...
var configureCommon = function (options, overrides) {
  ...
  var config = (0, webpack_merge_1.merge)(overrides, {
    ...
    resolve: {
      ...
      extensions: ['.web.mjs', '.mjs', '.esm.js', '.cjs', '.web.js', '.js', '.web.ts', '.ts', '.tsx', '.json', '.jsx', '.csv'],
      fallback: {
      ...
      rules: Array.prototype.filter.call(
        __spreadArray(
          __spreadArray(
            ...
            [(0, csvLoader_1.createCSVLoader)(), (0, svgLoader_1.createSVGLoader)(), (0, mdLoader_1.createMDLoader)()],
            false,
          ),
          __read((0, css_1.createCSSLoaders)({ isDevelopment: isDevelopment, isProduction: isProduction, isNode: isNode })),
          false,
        ),
        function (x) {
          return !!x;
