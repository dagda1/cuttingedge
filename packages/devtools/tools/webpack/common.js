...
var fork_ts_checker_webpack_plugin_1 = __importDefault(
  require("fork-ts-checker-webpack-plugin")
);
var paths_1 = require("../config/paths");
var simple_progress_webpack_plugin_1 = __importDefault(
  require("simple-progress-webpack-plugin")
);
...
var ModuleScopePlugin_1 = __importDefault(
...
var image_minimizer_webpack_plugin_1 = __importDefault(
...
var reactRefreshWebpackPluginRuntimeEntry = require.resolve(
  "@pmmmwh/react-refresh-webpack-plugin"
);
var babelRuntimeEntryHelpers = require.resolve(
  "@babel/runtime/helpers/esm/assertThisInitialized"
);
var babelRuntimeRegenerator = require.resolve("@babel/runtime/regenerator");
var reactRefreshOverlay = require.resolve(
  "@pmmmwh/react-refresh-webpack-plugin/overlay"
);
var reactRefreshRuntimeUtils = require.resolve(
  "@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js"
);
var miniCssHot = require.resolve(
...
var configureCommon = function (options, overrides) {
  ...
  var _a = (0, getEnvironment_1.getEnvironment)(),
    ...
    staticAssetName = _a.staticAssetName,
    isAnalyse = _a.isAnalyse;
  var env = (0, getEnvironment_1.getEnvVariables)({ isNode: !!options.isNode });
  var cssFile =
    (0, getFileName_1.getFileName)({
  ...
  var config = (0, webpack_merge_1.merge)(overrides, {
    ...
    resolve: {
      ...
      modules: [
        path_1.default.join(
          process.cwd(),
          paths_1.paths.resolvedNodeModules[0]
        ),
        "./node_modules",
        ...
        __spreadArray(
          __spreadArray(
            __spreadArray(
              __spreadArray(
                [
                  (0, fileLoader_1.createFileLoader)({
                    isWeb: isWeb,
                ...
                __read(
                  (0, typescriptLoader_1.createTypescriptLoader)({
                    isDevelopment: isDevelopment,
                    isNode: isNode,
                    moduleFormat: isNode ? "cjs" : "esm",
                  })
                ),
                false
              ),
              __read(
                (0, jsLoader_1.createJsLoader)({
                  isDevelopment: isDevelopment,
                  isProduction: isProduction,
                  isNode: isNode,
                  moduleFormat: isNode ? "cjs" : "esm",
    ...
    plugins: Array.prototype.filter.call(
      [
        ...
        isDevelopment &&
          new simple_progress_webpack_plugin_1.default({
            color: true,
            format: "expanded",
          }),
        isAnalyse &&
        ...
        new webpack_1.default.ContextReplacementPlugin(
          /moment[\/\\]locale$/,
          /en/
        ),
        ...
        isDevelopment &&
          new webpack_1.default.WatchIgnorePlugin({
            paths: [paths_1.paths.appManifest],
          }),
