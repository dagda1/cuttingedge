...
const isModuleCSS = (module) => {
  return module.type === `css/mini-extract` || module.type === `css/extract-chunks` || module.type === `css/extract-css-chunks`;
};
const createWebpackOptimisation = ({ optimization, isProduction }) =>
  Object.assign(Object.assign({}, optimization), {
