  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          ...
          return [
            ...
            Promise.resolve().then(function () {
              return __importStar(require(pkgJsonPath));
            }),
          ];
        case 1:
          pkg = _d.sent().default;
        ...
        case 8:
          try {
            if (configs_1_1 && !configs_1_1.done && (_c = configs_1.return)) {
              _c.call(configs_1);
            }
          } finally {
            if (e_1) {
          ...
          return [7 /*endfinally*/];
        case 9:
          return [4 /*yield*/, (0, helpers_1.writeCjsEntryFile)(packageName)];
        case 10:
          _d.sent();
