...
var createInitialFiles = function () {
  ...
  if (!fs_extra_1.default.existsSync(paths_1.paths.tsConfig)) {
    fs_extra_1.default.copyFileSync(
      path_1.default.join(__dirname, "../../demo/tsconfig.json"),
  ...
  if (!fs_extra_1.default.existsSync(paths_1.paths.eslintConfig)) {
    ...
    fs_extra_1.default.copyFileSync(
      path_1.default.join(__dirname, "../../typescript/.eslintrc.json"),
      path_1.default.join(paths_1.paths.eslintConfig)
    );
  }
  if (!fs_extra_1.default.existsSync(paths_1.paths.gitIgnore)) {
    fs_extra_1.default.copyFileSync(
      path_1.default.join(__dirname, "../../init/.gitignore"),
      paths_1.paths.gitIgnore
    );
