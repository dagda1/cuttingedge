...
function findExecutable(current, executable, tries) {
  ...
  var modulesDir = path_1.default.resolve(
    current,
    "node_modules",
    ".bin",
    executable
...
function runEslint() {
  ...
  var args =
    ...
    " --ignore-pattern *.test.* -c " +
    eslintConfig +
    " --fix";
  var eslint = (0, child_process_1.exec)(eslintPath + " " + args);
  (_a = eslint.stdout) === null || _a === void 0
    ? void 0
    : _a.on("data", function (data) {
        return logger_1.logger.info(data);
      });
  (_b = eslint.stderr) === null || _b === void 0
    ? void 0
    : _b.on("data", function (data) {
        return logger_1.logger.error(data);
      });
...
function runTypeScriptBuild() {
  ...
  if (paths_1.paths.projectReferences) {
    ...
    process.argv.push(
      "-p",
      isProduction ? paths_1.paths.tsConfigProduction : paths_1.paths.tsConfig
    );
  }
  ...
  logger_1.logger.info(
    "running " +
      path_1.default.basename(tscCommand) +
      ", in " +
      path_1.default.dirname(process.cwd())
  );
  logger_1.logger.start("running tsc");
  var tsc = (0, child_process_1.exec)(tscCommand);
  (_a = tsc.stdout) === null || _a === void 0
    ? void 0
    : _a.on("data", function (data) {
        return logger_1.logger.info(data);
      });
  (_b = tsc.stderr) === null || _b === void 0
    ? void 0
    : _b.on("data", function (data) {
        return logger_1.logger.error(data);
      });
