# AI Builds Fast. Then You Pay For It.
...
Meanwhile, material-react-table exists. Three years of edge cases solved. Keyboard navigation, cell validation, copy/paste, accessibility, column resizing - all done. Tested by thousands of developers. But AI didn't know to use it, and nobody asked.
...
I reviewed a PR recently with an 800-line file - a near-copy of an existing utility with loosened types, no tests, and the recursive handling stripped out. GitHub hides large files by default. I missed it the first time.
...
_I fix frontend messes - AI-generated or otherwise. If your codebase is slowing you down, [let's talk](https://frontendrescue.com)._
