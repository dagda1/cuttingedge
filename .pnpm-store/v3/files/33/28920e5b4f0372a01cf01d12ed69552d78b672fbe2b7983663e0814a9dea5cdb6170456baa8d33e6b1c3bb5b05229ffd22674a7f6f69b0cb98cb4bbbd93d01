...
var Menu = (function () {
        ...
        this.menu = MJContextMenu_js_1.MJContextMenu.parse({
            menu: {
                ...
                pool: [
                    ...
                    this.variable('highlight'),
                    this.variable('background'),
                    this.variable('foreground'),
                    this.variable('speech'),
                    this.variable('subtitles'),
                    this.variable('speechrules'),
    ...
    Menu.prototype.checkLoadableItems = function () {
        ...
        if (MathJax && MathJax._ && MathJax.loader && MathJax.startup) {
            ...
            var menu = this.menu;
            try {
                for (var _a = __values(Object.keys(this.jax)), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var name_1 = _b.value;
                    if (!this.jax[name_1]) {
    ...
    Menu.prototype.enableExplorerItems = function (enable) {
        var menu = this.menu.findID('Accessibility', 'Explorer').getSubmenu();
        try {
            for (var _a = __values(menu.getItems().slice(3)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var item = _b.value;
    ...
    Menu.prototype.saveUserSettings = function () {
        var settings = {};
        try {
            for (var _a = __values(Object.keys(this.settings)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var name_2 = _b.value;
    ...
    Menu.prototype.loadA11y = function (component) {
        ...
        this.loadComponent('a11y/' + component, function () {
            ...
            _this.document = startup.getDocument();
    ...
    Menu.prototype.transferMathList = function (document) {
        ...
        try {
            for (var _a = __values(document.math), _b = _a.next(); !_b.done; _b = _a.next()) {
                var item = _b.value;
