...
var VictoryStack = function (initialProps) {
  ...
  if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(events)) {
    return react__WEBPACK_IMPORTED_MODULE_4___default().createElement(victory_shared_events__WEBPACK_IMPORTED_MODULE_11__["default"], {
      container: container,
      eventKey: eventKey,
      events: events,
...
VictoryStack.propTypes = _objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_12__.baseProps, {
  bins: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOfType([victory_core__WEBPACK_IMPORTED_MODULE_13__.nonNegative, prop_types__WEBPACK_IMPORTED_MODULE_3___default().instanceOf(Date)])), victory_core__WEBPACK_IMPORTED_MODULE_13__.nonNegative]),
